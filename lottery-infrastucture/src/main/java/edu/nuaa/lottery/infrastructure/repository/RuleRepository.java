...
import edu.nuaa.lottery.infrastructure.dao.IRuleTreeDao;
import edu.nuaa.lottery.infrastructure.dao.IRuleTreeNodeDao;
import edu.nuaa.lottery.infrastructure.dao.IRuleTreeNodeLineDao;
...
public class RuleRepository implements IRuleRepository {
    ...
    public TreeRuleRich queryTreeRuleRich(Long treeId) {
        ...
        for (RuleTreeNode treeNode : ruleTreeNodeList) {
            ...
            if (RuleConstants.NodeType.STEM.equals(treeNode.getNodeType())) {
