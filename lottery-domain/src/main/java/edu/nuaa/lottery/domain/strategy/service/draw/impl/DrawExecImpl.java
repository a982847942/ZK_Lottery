...
import edu.nuaa.lottery.domain.strategy.service.draw.AbstractDrawBase;
...
public class DrawExecImpl extends AbstractDrawBase {
    ...
    protected String drawAlgorithm(Long strategyId, IDrawAlgorithm iDrawAlgorithm, List<String> excludeAwardIds) {
         ...
         */
        boolean isSuccess = iStrategyRepository.deductStock(strategyId, awardId);
    ...
    protected List<String> queryExcludeAwardIds(Long strategyId) {
        List<String> awardList = iStrategyRepository.queryNoStockStrategyAwardList(strategyId);
